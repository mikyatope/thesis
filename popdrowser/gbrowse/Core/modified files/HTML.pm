...
sub download_track_menu {
    ...
    if ($track=~ /[a-z]{1}\..*bp/ || $track=~ /recombination_map.*/){
        $html   .= div({-align=>'center'},
		   div({-style => 'background:gainsboro;padding:5px;font-weight:bold'},$key.$track),br());

	$html   .= "<p>Quantitative tracks can be downloaded in our FTP directory</p>";
	$html   .= "<a href='ftp://popdrowser.uab.cat/dgrp.freeze1/precomputed/' target='_blank'>[FTP Directory]</a>";
